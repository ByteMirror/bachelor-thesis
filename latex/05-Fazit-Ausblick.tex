...
\begin{enumerate}
    \item \textbf{Moderne Rendering-Engine}: PIXI.js v8 mit \ac{WebGL}-Backend nutzt \ac{GPU}-Beschleunigung effektiv aus. Das automatische Sprite-Batching\autocite{PixiPerf2024} sowie die TilingSprite-basierte Grid-Implementierung (vgl. \autoref{subsec:grid-system}) reduzieren die Anzahl der Draw-Calls.
