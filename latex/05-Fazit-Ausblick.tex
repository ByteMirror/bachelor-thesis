...
Die Implementierung von Atlas \ac{VTT} demonstriert, dass performante \ac{VTT}-Plugins in Obsidian grundsätzlich realisierbar sind. Die gemessenen 120 \ac{FPS} und Frame Times von 8,33 \ac{ms} übertreffen die definierten Anforderungen (>30 \ac{FPS}, <100ms Eingabelatenz) deutlich. Die Electron-Umgebung stellt somit keine prinzipielle Barriere für Echtzeit-Rendering-Anwendungen dar.
