...
\usetikzlibrary{positioning,shapes.geometric,arrows.meta,calc}%  TikZ-Libraries %
\usepackage[pdftex,cmyk,dvipsnames]{xcolor}%          Treiber-unabhängige Farb- %
...
\lstdefinelanguage{TypeScript}{
  ...
  ndkeywords={Array, Boolean, Date, Function, Map, Math, Number, Object, Promise, RegExp, Set, String, Symbol, WeakMap, WeakSet},
