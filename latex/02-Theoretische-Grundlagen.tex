...
Plugin-Architekturen ermöglichen die Erweiterbarkeit von Anwendungen ohne Modifikation des Kernsystems. Das Architekturmuster basiert auf der Trennung zwischen einem stabilen Kernsystem und dynamisch ladbaren Erweiterungsmodulen, die über wohldefinierte Schnittstellen kommunizieren. Das \textit{Microkernel Pattern} strukturiert dabei die Anwendung in einen minimalen Kern mit essentiellen Funktionalitäten und Plugin-Module für spezifische Features \autocite{Richards2024MicrokernelArchitecture}.
